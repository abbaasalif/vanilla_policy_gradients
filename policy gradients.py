...
num_hidden_one = tf.layers.dense(X, num_hidden, activation=tf.nn.relu, kernel_initializer=initializer)

logits = tf.layers.dense(num_hidden_one, num_outputs)
outputs = tf.nn.sigmoid(logits)
# reason we write seperately is because we use both these layers seperately in code
